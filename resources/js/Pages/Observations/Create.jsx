...
export default function Create() {
    ...
    return (
        <div className="max-w-xl mx-auto py-8">
            <h1 className="text-2xl font-bold mb-6">Log New Observation</h1>
            <form onSubmit={handleSubmit} className="space-y-4 bg-white shadow rounded-lg p-6">
                ...
                <div className="flex gap-4 justify-end">
                    ...
                    <button type="submit" className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700" disabled={processing}>Save</button>
                </div>
            </form>
        </div>
    );
